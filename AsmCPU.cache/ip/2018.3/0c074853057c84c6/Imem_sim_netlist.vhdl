...
begin
  ...
  spo(3 downto 1) <= \^spo\(11 downto 9);
  spo(0) <= \^spo\(0);
...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_12_synth
     port map (
      ...
      spo(12 downto 1) => \^spo\(15 downto 4),
      spo(0) => \^spo\(0)
    );
end STRUCTURE;
library IEEE;
